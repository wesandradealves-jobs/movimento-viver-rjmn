...
(function($, window, document, undefined) {
    $.fn.socialfeed = function(_options) {
        ...
        var options = $.extend(defaults, _options),
            container = $(this),
            template,
            social_networks = ['facebook', 'instagram', 'vk', 'google', 'blogspot', 'twitter', 'pinterest', 'youtube'],
        ...
        var Feed = {
                        ...
                        if (element.id) {
                            ...
                            if (options.show_media === true) {
                                if (element.entities.media && element.entities.media.length > 0) {
                                    ...
                                    if (image_url) {
                                        post.attachment = '<img width="100%" class="attachment" src="' + image_url + '" />';
                                    }
                                }
                            }
                        }
            ...
            facebook: {
                ...
                utility: {
                    ...
                    prepareAttachment: function(element) {
                        ...
                        return '<img width="100%" class="attachment" src="' + image_url + '" />';
                    },
                ...
                utility: {
                    ...
                    unifyPostData: function(element) {
                        ...
                        if (options.show_media) {
                            post.attachment = '<img width="100%" class="attachment" src="' + element.images.standard_resolution.url + '' + '" />';
                        }
                        return post;
                    }
                }
            ...
            youtube : {
                ...
                getData: function(url) {
                    ...
                    Utility.request(request_url, Feed.youtube.utility.getPosts, Feed.youtube.datatype);
                },
                utility: {
                    ...
                    getPosts: function(json) {
                        ...
                        if (json.query.count > 0 ){
                            $.each(json.query.results.feed, function(index, element) {
                                var post = new SocialFeedPost('youtube', Feed.youtube.utility.unifyPostData(index, element));
                                post.render();
                            });
                        }
                    },
                    ...
                    unifyPostData: function(index, element){
                        ...
                        post.author_link = '';
                        post.author_picture = 'http://findicons.com/files/icons/2052/social_network/32/youtube.png';
                        post.author_name = '';
                        ...
                        post.attachment = '<div class="video-container"><iframe type="text/html" width="100%" height="auto" src="https://www.youtube.com/embed/' + idVideo + '" frameborder="0" allowfullscreen></iframe></div>';
                        return post;
                    }
                }
            }
